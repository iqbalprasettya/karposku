...
class FaceDetectionScreeen extends StatefulWidget {
  const FaceDetectionScreeen({super.key});

  static String routeName = 'registration-screen';

  @override
  State<FaceDetectionScreeen> createState() => _FaceDetectionScreeenState();
}

class _FaceDetectionScreeenState extends State<FaceDetectionScreeen> {
